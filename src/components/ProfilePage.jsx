      ...
      <div className="w-full max-w-5xl bg-white rounded-lg shadow-lg p-8">
        ...
        <div className="flex justify-between items-center pb-6 border-b border-gray-300">
          <div className="flex items-center">
            ...
            <div>
              <input
                className="text-2xl font-semibold text-gray-800 bg-transparent border-none focus:outline-none"
                value={user.name}
        ...
        <div className="grid grid-cols-3 gap-8 mt-6">
          ...
          <div>
            ...
            <ul>
              {user.work.map((job, index) => (
                <li
                  key={index}
                  className="text-sm text-gray-600 mb-2 flex justify-between items-center"
                >
                  <input
          ...
          <div>
            ...
            <textarea
              className="text-sm text-gray-600 leading-6 w-full bg-transparent border-none focus:outline-none"
              value={user.about}
